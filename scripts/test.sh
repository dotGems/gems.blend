...
cleos push action atomicassets createschema '["mycollection", "mycollection", "water", [{"name": "name", "type": "string"}, {"name": "img", "type": "string"}, {"name": "rarity", "type": "string"}, {"name": "color", "type": "string"}, {"name": "shape", "type": "string"}, {"name": "clarity", "type": "string"}]]' -p mycollection

# create NFT templates
cleos push action atomicassets createtempl '["mycollection", "mycollection", "potion", true, true, 0, [{"key": "name","value": ["string", "Water Bottle"]}]]' -p mycollection -f
cleos push action atomicassets createtempl '["mycollection", "mycollection", "water", true, true, 0, [{"key": "name", "value": ["string", "Water Drop"]}]]' -p mycollection -f
cleos push action atomicassets createtempl '["mycollection", "mycollection", "water", true, true, 0, [{"key": "name", "value": ["string", "Water Pond"]}]]' -p mycollection -f

# mint Water Bottle
cleos push action atomicassets mintasset '["mycollection", "mycollection", "potion", 1, "myaccount", [], [], []]' -p mycollection -f

# mint Water Drops
cleos push action atomicassets mintasset '["mycollection", "mycollection", "water", 2, "myaccount", [{"key": "clarity", "value": ["string", "FL"]}, {"key": "shape", "value": ["string", "Round"]}, {"key": "color", "value": ["string", "Rose"]}], [], []]' -p mycollection -f
cleos push action atomicassets mintasset '["mycollection", "mycollection", "water", 2, "myaccount", [{"key": "clarity", "value": ["string", "FL"]}, {"key": "shape", "value": ["string", "Round"]}, {"key": "color", "value": ["string", "Rose"]}], [], []]' -p mycollection -f
cleos push action atomicassets mintasset '["mycollection", "mycollection", "water", 2, "myaccount", [{"key": "clarity", "value": ["string", "FL"]}, {"key": "shape", "value": ["string", "Round"]}, {"key": "color", "value": ["string", "Rose"]}], [], []]' -p mycollection -f
cleos push action atomicassets mintasset '["mycollection", "mycollection", "water", 2, "myaccount", [{"key": "clarity", "value": ["string", "FL"]}, {"key": "shape", "value": ["string", "Round"]}, {"key": "color", "value": ["string", "Rose"]}], [], []]' -p mycollection -f
cleos push action atomicassets mintasset '["mycollection", "mycollection", "water", 2, "myaccount", [{"key": "clarity", "value": ["string", "FL"]}, {"key": "shape", "value": ["string", "Round"]}, {"key": "color", "value": ["string", "Rose"]}], [], []]' -p mycollection -f
...
cleos push action blend.gems setblend '[["mycollection", 3], "Water Pond", "water", null, null, null]' -p mycollection
