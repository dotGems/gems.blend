...
cleos push action blend.gems setblend '[["mycollection", 2], "My Blend", null, null]' -p blend.gems
cleos push action blend.gems addrecipe '[["mycollection", 2], [["mycollection", 1], ["mycollection", 2], ["mycollection", 3]]]' -p blend.gems
