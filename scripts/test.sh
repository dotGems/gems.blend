...
cleos push action blend.gems setblend '["myblend", [["mycollection", 1], ["mycollection", 2], ["mycollection", 3]], [["mycollection", 4]], ["1.00000000 WAX"], "2021-07-05T00:00:00"]' -p blend.gems
