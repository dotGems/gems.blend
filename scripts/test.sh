...
cleos push action blend.gems setblend '["multicoltest1", [["mycollection", 1], ["mycollection", 2], ["mycollection", 3]], [["mycollection", 4]], "1.00000000 WAX", "2021-07-05T00:00:00"]' -p blend.gems

# user send NFT's to be blended (memo optional)
cleos push action atomicassets transfer '["myaccount", "blend.gems", [1099511627776, 1099511627777, 1099511627778, 1099511627779], "multicoltest1"]' -p myaccount -p mycollection
