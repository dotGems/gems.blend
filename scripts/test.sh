...
cleos push action blend.gems initrecipe '[[["mycollection", 1], ["mycollection", 2], ["mycollection", 3]]]' -p blend.gems
cleos push action blend.gems setblend '[["mycollection", 2], [0], "My Blend", null, null]' -p blend.gems
